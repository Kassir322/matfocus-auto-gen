...
│
├── logs/
│   └── auto-gen_YYYY-MM-DD_HH-MM-SS.log   # Один файл на запуск (дата и время до секунды)
│
├── docs/                      # Документация
│   ├── PLAN_V2.md
│   ├── ALGO_standard.md
...
|-----------|------------|
| `auto-gen_YYYY-MM-DD_HH-MM-SS.log` | Лог сессии (новый файл при каждом запуске, дата и время до секунды) |
